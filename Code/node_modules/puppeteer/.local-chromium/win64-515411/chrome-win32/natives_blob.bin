...
l.source=function(R){
if(!(%IsFunction(R)))throw %make_type_error(44);
...
if(!(%IsFunction(S)))throw %make_type_error(44);
...
if(!(%IsFunction(R)))throw %make_error(44);
...
toLocaleString(){
if((%IS_VAR(this)===null)||(this===(void 0)))throw %make_type_error(25,"Object.prototype.toLocaleString");
...
throw %make_type_error(23,typeof g);
}
function GetIterator(e,h){
if((h===(void 0))){
h=e[d];
}
if(!(typeof(h)==='function')){
throw %make_type_error(85,e);
}
var i=%_Call(h,e);
if(!(%_IsJSReceiver(i))){
throw %make_type_error(78,i);
}
return i;
}
b.Export(function(j){
j.GetIterator=GetIterator;
j.GetMethod=GetMethod;
});
})
...
if(ae>9007199254740991-ad)throw %make_type_error(249,ae,ad);
for(var w=0;w<ae;w++){
o[w+ad]=arguments[w];
}
var af=ad+ae;
...
if(%object_is_sealed(o))throw %make_type_error(13);
var ap=o[0];
...
function InnerArrayFind(bi,bj,o,p){
if(!(typeof(bi)==='function')){
throw %make_type_error(23,bi);
}
for(var w=0;w<p;w++){
var aE=o[w];
if(%_Call(bi,bj,aE,w,o)){
return aE;
}
}
return;
}
%DefineMethodsInternal(f.prototype,class{find(bi,bj){
var o=(%_ToObject(this));
var p=(%_ToInteger(o.length));
return InnerArrayFind(bi,bj,o,p);
}},1);
function InnerArrayFindIndex(bi,bj,o,p){
if(!(typeof(bi)==='function')){
throw %make_type_error(23,bi);
}
for(var w=0;w<p;w++){
...
%DefineMethodsInternal(f.prototype,class{findIndex(bi,bj){
var o=(%_ToObject(this));
var p=(%_ToInteger(o.length));
return InnerArrayFindIndex(bi,bj,o,p);
}},1);
...
var bk=(%_ToObject(arrayLike));
var bl=!(mapfn===(void 0));
if(bl){
if(!(typeof(mapfn)==='function')){
throw %make_type_error(23,mapfn);
}
}
var bm=e(bk,l);
var S;
...
{[l](){return d(bk,bm)}}){
if(bl){
bn=%_Call(mapfn,receiver,bo,S);
}else{
bn=bo;
}
%CreateDataProperty(av,S,bn);
S++;
}
av.length=S;
return av;
}else{
var P=(%_ToLength(bk.length));
av=%IsConstructor(this)?new this(P):new f(P);
for(S=0;S<P;++S){
bo=bk[S];
if(bl){
bn=%_Call(mapfn,receiver,bo,S);
...
var p=args.length;
var q=this;
var o=%IsConstructor(q)?new q(p):[];
for(var w=0;w<p;w++){
%CreateDataProperty(o,w,args[w]);
}
o.length=p;
return o;
}},-1);
...
%ToFastProperties(bp);
%AddNamedProperty(f.prototype,m,bp,
2|1);
var bq=f.prototype.indexOf;
var aa=f.prototype.join;
var br=f.prototype.pop;
var bs=f.prototype.push;
var bt=f.prototype.slice;
var bu=f.prototype.shift;
var bv=f.prototype.sort;
var bw=f.prototype.splice;
var bx=f.prototype.toString;
var by=f.prototype.unshift;
var bz=f.prototype.entries;
var bA=f.prototype.forEach;
var bB=f.prototype.keys;
var bC=f.prototype[l];
...
%InstallToContext([
"array_entries_iterator",bz,
"array_for_each_iterator",bA,
"array_keys_iterator",bB,
...
throw %make_type_error(261);
}
function ValidateTypedArray(J,K){
if(!(%_IsTypedArray(J))
)throw %make_type_error(88);
if(%_ArrayBufferViewWasNeutered(J))
throw %make_type_error(47,K);
}
...
if((%_ClassOf(N)==='ArrayBuffer')
||(%_ClassOf(N)==='SharedArrayBuffer')
){
...
throw %make_type_error(37,"Uint8Array")
}
}
...
throw %make_type_error(37,"Int8Array")
}
}
...
throw %make_type_error(37,"Uint16Array")
}
}
...
throw %make_type_error(37,"Int16Array")
}
}
...
throw %make_type_error(37,"Uint32Array")
}
}
...
throw %make_type_error(37,"Int32Array")
}
}
...
throw %make_type_error(37,"Float32Array")
}
}
...
throw %make_type_error(37,"Float64Array")
}
}
...
throw %make_type_error(37,"Uint8ClampedArray")
}
}
...
function InnerTypedArrayFilter(am,an,J,Z,ao){
var ap=0;
for(var aq=0;aq<Z;aq++){
if(aq in J){
var ar=J[aq];
if(%_Call(am,an,ar,aq,J)){
%CreateDataProperty(ao,ap,ar);
ap++;
}
}
}
...
%DefineMethodsInternal(D.prototype,class{filter(am,thisArg){
ValidateTypedArray(this,"%TypeArray%.prototype.filter");
var Z=%_TypedArrayGetLength(this);
if(!(typeof(am)==='function'))throw %make_type_error(23,am);
var ao=new o();
InnerTypedArrayFilter(am,thisArg,this,Z,ao);
var as=ao.length;
var at=TypedArraySpeciesCreate(this,as);
...
throw %make_type_error(16,comparefn);
}
var Z=%_TypedArrayGetLength(this);
if((comparefn===(void 0))){
...
function IterableToArrayLike(au){
var S=e(au,r);
if(!(S===(void 0))){
var av=new o();
var aq=0;
...
var J=[];
%MoveArrayContents(av,J);
return J;
}
return(%_ToObject(au));
}
%DefineMethodsInternal(D,class{'from'(source,mapfn,thisArg){
if(!%IsConstructor(this))throw %make_type_error(80,this);
var aw;
if(!(mapfn===(void 0))){
if(!(typeof(mapfn)==='function'))throw %make_type_error(23,this);
aw=true;
}else{
aw=false;
}
var ax=IterableToArrayLike(source);
var Z=(%_ToLength(ax.length));
var ay=TypedArrayCreate(this,Z);
var X,az;
for(var aq=0;aq<Z;aq++){
X=ax[aq];
if(aw){
az=%_Call(mapfn,thisArg,X,aq);
}else{
az=X;
}
ay[aq]=az;
...
throw %make_type_error(34,"TypedArray");
}
...
if((new.target===(void 0))){
throw %make_type_error(37,"WeakMap");
}
%WeakCollectionInitialize(this);
if(!(f==null)){
var g=this.set;
if(!(typeof(g)==='function')){
throw %make_type_error(103,g,'set',this);
}
for(var h of f){
if(!(%_IsJSReceiver(h))){
throw %make_type_error(64,h);
}
...
if((new.target===(void 0))){
throw %make_type_error(37,"WeakSet");
}
%WeakCollectionInitialize(this);
if(!(f==null)){
var g=this.add;
if(!(typeof(g)==='function')){
throw %make_type_error(103,g,'add',this);
}
for(var i of f){
%_Call(g,this,i);
}
...
throw %make_range_error(199,ah,ab,ad);
}
return ah;
}
return ag;
...
if((aE===null))throw %make_range_error(167,aD);
...
if((new.target===(void 0))){
throw %make_type_error(37,"PluralRules");
}
var B=arguments[0];
var C=arguments[1];
if((C===(void 0))){
...
throw %make_range_error(174,bs);
}
if(bh.style==='currency'&&(bs===(void 0))){
throw %make_type_error(39);
}
var bC,bD;
var bE=ac(
...
if((%IS_VAR(this)===null)||(this===(void 0)))throw %make_type_error(25,"Intl.DateTimeFormat.prototype.formatToParts");
if(!(typeof(this)==='object')
){
throw %make_type_error(24,this);
}
...
if((aE===null))throw %make_range_error(166,bZ);
...
throw %make_type_error(68,"Number");
}
var B=arguments[0];
var C=arguments[1];
