...
class Frame {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (typeof options.url === 'string') {
      ...
      try {
        return (yield this._context.evaluateHandle(addScriptUrl, url));
      } catch (error) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (typeof options.url === 'string') {
      const url = options.url;
      try {
        return (yield this._context.evaluateHandle(addStyleUrl, url));
      } catch (error) {
    ...
    if (typeof options.path === 'string') {
      ...
      return (yield this._context.evaluateHandle(addStyleContent, contents));
    }

    if (typeof options.content === 'string')
      return (yield this._context.evaluateHandle(addStyleContent, options.content));
