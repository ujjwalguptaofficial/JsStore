                ...
                _this.getKeyRange = function (whereIn) {
                    ...
                    switch (whereIn.Op) {
                        ...
                        case '<=':
                            ...
                            break;
                        case '~':
                            KeyRange = IDBKeyRange.bound(whereIn.Value.toUpperCase(), whereIn.Value.toUpperCase() + 'Z' + '\uffff');
                            break;
                        case '=':
        ...
        var SelectJoinLogic = (function (_super) {
            ...
            function SelectJoinLogic(query, onSuccess, onError) {
                ...
                _this.executeWhereUndefinedLogicForJoin = function (joinQuery, query) {
                    var That = this, Results = [], JoinIndex = 0, Column = query.Column, TmpResults = That.Results, Item, ResultLength = TmpResults.length, ItemIndex = 0, Where = {}, doJoin = function (results) {
                        if (results.length > 0) {
