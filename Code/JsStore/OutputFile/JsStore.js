...
(function (JsStore) {
    var Instance = (function () {
        function Instance() {
            this.QueryRequests = [];
            this.executeCode = function (query) {
            ...
            this.createWorker = function () {
                var That = this, Url = new JsStore.WebWorker.MainLogic().getWorkerUrl();
...
(function (JsStore) {
    ...
    (function (Business) {
        var WorkerEvents = (function () {
            function WorkerEvents() {
                this.checkConnectionAndExecuteLogic = function (request) {
                    if (Business.ConnStatus.ConStatus == JsStore.ConnectionStatus.Connected) {
                        this.executeLogic(request);
                    }
                    else if (Business.ConnStatus.ConStatus == JsStore.ConnectionStatus.NotStarted) {
                        var That = this;
                        setTimeout(function () {
                            That.checkConnectionAndExecuteLogic(request);
                        }, 50);
                    }
                    else if (Business.ConnStatus.ConStatus == JsStore.ConnectionStatus.Closed) {
                        var That = this;
                        setTimeout(function () {
                            That.checkConnectionAndExecuteLogic(request);
                        }, 50);
                ...
                this.executeLogic = function (request) {
                    ...
                    }, IndexDbObject = new Business.MainLogic();
                    switch (request.Name) {
                        case 'select':
                        ...
                        case 'delete': break;
                        case 'createDb':
                            IndexDbObject.createDb(request.Value, OnSuccess, OnError);
                            break;
                        case 'clear': break;
                        case 'dropDb': break;
                        case 'count': break;
            ...
            WorkerEvents.registerWorkerEvents = function () {
                var That = this;
        ...
        Business.WorkerEvents = WorkerEvents;
    })(Business = JsStore.Business || (JsStore.Business = {}));
})(JsStore || (JsStore = {}));
var JsStore;
(function (JsStore) {
    ...
    (function (WebWorker) {
        var MainLogic = (function () {
            function MainLogic() {
                this.getWorkerUrl = function () {
                    var StringValue = this.getStringOfModels() + this.getStringOfBusiness() +
                        JsStore.Business.WorkerEvents.toString() + "Business.WorkerEvents.registerWorkerEvents();";
