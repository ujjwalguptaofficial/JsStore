...
import { IError, Error_Type } from "../error_helper";
import { active_db, db_connection, callDbDroppedByBrowser, setDbList } from "./MainLogic";
import { db_version, db_status } from "../CommonLogic";
import { Connection_Status } from "../enums";
import { Utils } from "../UtilsLogic";
import { Column } from "../Model/Column";
import { getDbList } from "../HelperLogic";

export class CreateDb {
    constructor(tablesMetaData: TableHelper[],
        ...
        db_request.onupgradeneeded = function (event) {
            ...
            tablesMetaData.forEach(function (item: TableHelper, index) {
        ...
        var createObjectStore = function (item: TableHelper, index) {
            try {
