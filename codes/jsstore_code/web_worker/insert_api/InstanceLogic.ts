import { createTransaction, db_transaction } from "../query_executor";
import { IInsert } from "../../interfaces";
import { Table } from "../../Model/Table";
import { Base } from "../BaseLogic";
import { ErrorHelper, Error_Type, IError } from "../../error_helper";
import { ValuesChecker } from "./ValuesCheckerLogic";
...
export class Instance extends Base {
    ...
    execute() {
        ...
        if (!Array.isArray(this._query.Values)) {
            ...
            new ErrorHelper(Error_Type.TableNotExist, { TableName: this._tableName }).throw();
        }
    }
