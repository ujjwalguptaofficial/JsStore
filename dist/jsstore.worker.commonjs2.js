...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "QueryExecutor", function() { return /* reexport */ worker_query_executor_QueryExecutor; });
...
__webpack_require__.d(__webpack_exports__, "KeyStore", function() { return /* reexport */ instance_KeyStore; });
...
})(enums_CONNECTION_STATUS || (enums_CONNECTION_STATUS = {}));

// CONCATENATED MODULE: ./src/worker/keystore/business/base_logic.ts
var base_logic_Base = /** @class */ (function () {
    function Base() {
        this.results = null;
...
var base_db_BaseDb = /** @class */ (function () {
    function BaseDb() {
    }
...
var drop_db_DropDb = /** @class */ (function (_super) {
        ...
        return promise(function (res, rej) {
            ...
            _this.getDbList().then(function (dbList) {
                ...
                _this.setDbList(dbList).then(function () {
                    ...
                    instance_KeyStore.remove("JsStore_" + _this.dbName + "_Schema").
                        then(res).catch(rej);
                });
            });
        });
...
// CONCATENATED MODULE: ./src/worker/business/idb_helper.ts




var business_idb_helper_IdbHelper = /** @class */ (function () {
    function IdbHelper() {
    }
    IdbHelper.callDbDroppedByBrowser = function (deleteMetaData) {
        if (IdbHelper.dbStatus.conStatus === CONNECTION_STATUS.Connected) {
            ...
            if (deleteMetaData === true) {
                var dropDbObject = new drop_db_DropDb(function () {
                }, function () {
                });
...
var schema_checker_SchemaChecker = /** @class */ (function () {
    ...
    SchemaChecker.prototype.checkByColumn_ = function (column, value) {
        ...
        if (column.notNull === true && isNull(value)) {
            log = new log_helper_LogHelper(ERROR_TYPE.NullValue, { ColumnName: column.name });
        }
        // check datatype
        ...
        if (column.dataType && checkFurther) {
            if (type !== column.dataType && type !== 'object') {
                log = new log_helper_LogHelper(ERROR_TYPE.WrongDataType, { column: column.name });
            }
        }
...
var query_helper_QueryHelper = /** @class */ (function () {
    ...
    QueryHelper.prototype.isInsertQryValid_ = function (callBack) {
        ...
        if (table) {
            ...
            log = new log_helper_LogHelper(ERROR_TYPE.TableNotExist, { tableName: this.query.into });
        }
        callBack(table);
    ...
    QueryHelper.prototype.checkForNullInWhere_ = function () {
        for (var key in this.query.where) {
            if (this.query.where[key] == null) {
                this.error = new log_helper_LogHelper(ERROR_TYPE.NullValueInWhere, { column: key }).get();
                return;
            }
        }
    };
    QueryHelper.prototype.checkFetchQuery_ = function () {
        if (this.isTableExist_(this.query.from) === true) {
            ...
            this.error = new log_helper_LogHelper(ERROR_TYPE.TableNotExist, { tableName: this.query.from }).get();
        }
    };
...
var where_checker_WhereChecker = /** @class */ (function () {
    ...
    WhereChecker.prototype.checkIn = function (column, value) {
        return this.where[column][QUERY_OPTION.In].find(function (q) { return isEqual(q, value); }) != null;
    };
...
// CONCATENATED MODULE: ./src/worker/business/where_base.ts
    ...
    NotWhere.prototype.executeWhereUndefinedLogic = function () {
        if (this.query.order && this.query.order.idbSorting !== false && this.query.order.by) {
            if (this.objectStore.indexNames.contains(this.query.order.by)) {
                ...
                var error = new log_helper_LogHelper(ERROR_TYPE.ColumnNotExist, { column: this.query.order.by, isOrder: true });
                this.onErrorOccured(error, true);
                return;
            }
        }
...
var orderby_helper_Helper = /** @class */ (function (_super) {
    ...
    Helper.prototype.getOrderColumnInfo_ = function (orderColumn) {
        ...
        if (column == null) {
            ...
            this.onErrorOccured(new log_helper_LogHelper(ERROR_TYPE.ColumnNotExist, { column: orderColumn, isOrder: true }), true);
        }
        return column;
    };
...
var count_not_where_NotWhere = /** @class */ (function (_super) {
...
var count_in_In = /** @class */ (function (_super) {
...
var count_regex_Regex = /** @class */ (function (_super) {
...
var count_where_Where = /** @class */ (function (_super) {
...
var count_instance_Instance = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./src/worker/business/insert/instance.ts
...
var insert_instance_Instance = /** @class */ (function (_super) {
...
var remove_not_where_NotWhere = /** @class */ (function (_super) {
...
var remove_in_In = /** @class */ (function (_super) {
...
var remove_regex_Regex = /** @class */ (function (_super) {
...
var remove_where_Where = /** @class */ (function (_super) {
...
var remove_instance_Instance = /** @class */ (function (_super) {
...
var update_not_where_NotWhere = /** @class */ (function (_super) {
...
var update_in_In = /** @class */ (function (_super) {
...
var update_regex_Regex = /** @class */ (function (_super) {
...
var update_where_Where = /** @class */ (function (_super) {
...
var update_instance_Instance = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./src/worker/business/transaction/instance.ts
...
var transaction_instance_Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        ...
        if (notExistingTable != null) {
            this.onError(new log_helper_LogHelper(ERROR_TYPE.TableNotExist, { tableName: notExistingTable }).get());
            return;
        }
    ...
    Instance.prototype.startExecution_ = function () {
        ...
        var start = function () {
            _this.checkQueries_(_this.reqQueue).then(function (_) {
                _this.startTx_();
            }).catch(function (err) {
                _this.onError(err);
            });
...
var table_helper_TableHelper = /** @class */ (function () {
    ...
    TableHelper.prototype.setDbVersion_ = function (dbName) {
        var _this = this;
        business_idb_helper_IdbHelper.activeDbVersion = business_idb_helper_IdbHelper.activeDbVersion > this.version ? business_idb_helper_IdbHelper.activeDbVersion : this.version;
        // setting db version
        instance_KeyStore.set("JsStore_" + dbName + "_Db_Version", business_idb_helper_IdbHelper.activeDbVersion);
...
var worker_query_executor_QueryExecutor = /** @class */ (function () {
        ...
        if (this.activeDb_ != null && this.activeDb_.name === dbName) {
            ...
            this.getDbSchema_(dbName).then(function (db) {
                if (db != null) {
                    ...
                    onError(new log_helper_LogHelper(ERROR_TYPE.DbNotExist, { dbName: dbName }).get());
                }
            }).catch(onError);
        }
    };
