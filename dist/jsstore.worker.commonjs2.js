...
var where_checker_WhereChecker = /** @class */ (function () {
    ...
    WhereChecker.prototype.checkIn = function (column, value) {
        return this.where[column][enums["g" /* QUERY_OPTION */].In].find(function (val) { return val === value; }) != null;
    };
    WhereChecker.prototype.checkLike_ = function (column, value) {
        return getRegexFromLikeExpression(this.where[column][enums["g" /* QUERY_OPTION */].Like]).test(value);
    };
        ...
        if (this.objectStore.indexNames.contains(columnName)) {
            ...
            if (typeof value === 'object') {
                ...
                switch (key) {
                    case enums["g" /* QUERY_OPTION */].Like:
                        {
                            var regexVal = getRegexFromLikeExpression(value[enums["g" /* QUERY_OPTION */].Like]);
...
var count_instance = __webpack_require__(29);
...
var update_instance = __webpack_require__(27);
...
/* harmony import */ var _count_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29);
...
/* harmony import */ var _update_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(27);
