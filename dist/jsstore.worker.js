...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return OCCURENCE; });
/* unused harmony export WEBWORKER_STATUS */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CONNECTION_STATUS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return DATA_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ERROR_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return QUERY_OPTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return IDB_MODE; });
...
var LogHelper = /** @class */ (function () {
    ...
    LogHelper.log = function (msg) {
        if (_config__WEBPACK_IMPORTED_MODULE_1__[/* Config */ "a"].isLogEnabled) {
            console.log(msg);
        }
    };
    ...
    LogHelper.prototype.getMsg_ = function () {
        var errMsg;
        switch (this.type) {
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NotArray:
                errMsg = "Supplied value is not an array";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].UndefinedColumn:
                errMsg = "Column is undefined in Where";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].UndefinedValue:
                errMsg = "Value is undefined in Where";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].UndefinedColumnName:
                errMsg = "Column name is undefined '" + this.info_['TableName'] + "'";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].UndefinedDbName:
                errMsg = "Database name is not supplied";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].UndefinedColumnValue:
                errMsg = "Column value is undefined";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NoValueSupplied:
                errMsg = "No value is supplied";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].InvalidOp:
                errMsg = "Invalid Op Value '" + this.info_['Op'] + "'";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].ColumnNotExist:
            ...
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NullValue:
                ...
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].WrongDataType:
                errMsg = "Supplied value for column '" + this.info_['ColumnName'] +
                    "' have wrong data type";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NextJoinNotExist:
                errMsg = "Next join details not supplied";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].TableNotExist:
                errMsg = "Table '" + this.info_['tableName'] + "' does not exist";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].DbNotExist:
                errMsg = "Database with name " + this.info_['dbName'] + " does not exist";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NotObject:
                errMsg = "supplied value is not object";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].InvalidOp:
                errMsg = "Invalid Config '" + this.info_['Config'] + " '";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].DbBlocked:
                errMsg = "database is blocked, cant be deleted right now";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].NullValueInWhere:
                errMsg = "Null/undefined is not allowed in where. Column '" + this.info_['column'] + "' has null";
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_0__[/* ERROR_TYPE */ "d"].InvalidJoinQuery:
                errMsg = this.info_;
                break;
            default:
                errMsg = this.message;
...
var IdbHelper = /** @class */ (function () {
    ...
    IdbHelper.callDbDroppedByBrowser = function (deleteMetaData) {
        if (IdbHelper.dbStatus.conStatus === _enums__WEBPACK_IMPORTED_MODULE_0__[/* CONNECTION_STATUS */ "b"].Connected) {
            IdbHelper.isDbDeletedByBrowser = true;
            if (deleteMetaData === true) {
                var dropDbObject = new _drop_db__WEBPACK_IMPORTED_MODULE_2__[/* DropDb */ "a"](function () {
                }, function () {
                });
    ...
    IdbHelper.createTransaction = function (tableNames, callBack, mode) {
        if (IdbHelper.transaction === null) {
            mode = mode ? mode : _enums__WEBPACK_IMPORTED_MODULE_0__[/* IDB_MODE */ "e"].ReadWrite;
    ...
    IdbHelper.setDbList = function (list) {
        return _keystore_index__WEBPACK_IMPORTED_MODULE_1__[/* KeyStore */ "a"].set('DataBase_List', list);
    };
    ...
    IdbHelper.getDbList = function () {
        return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_3__[/* promise */ "a"])(function (res, rej) {
            _keystore_index__WEBPACK_IMPORTED_MODULE_1__[/* KeyStore */ "a"].get('DataBase_List').then(function (result) {
    ...
    IdbHelper.getDbVersion = function (dbName) {
        return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_3__[/* promise */ "a"])(function (res, rej) {
            _keystore_index__WEBPACK_IMPORTED_MODULE_1__[/* KeyStore */ "a"].get("JsStore_" + dbName + "_Db_Version").then(function (dbVersion) {
                res(Number(dbVersion));
            }).catch(rej);
        });
    };
    IdbHelper.getDbSchema = function (dbName) {
        return _keystore_index__WEBPACK_IMPORTED_MODULE_1__[/* KeyStore */ "a"].get("JsStore_" + dbName + "_Schema");
    };
    ...
    IdbHelper.dbStatus = {
        conStatus: _enums__WEBPACK_IMPORTED_MODULE_0__[/* CONNECTION_STATUS */ "b"].NotStarted
    };
    return IdbHelper;
}());
...
var schema_checker_SchemaChecker = /** @class */ (function () {
    ...
    SchemaChecker.prototype.check = function (setValue, tblName) {
        var _this = this;
        var log = null;
        if (typeof setValue === enums["c" /* DATA_TYPE */].Object) {
            if (this.table) {
                ...
                log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].TableNotExist, { tableName: tblName });
            }
        }
        else {
            log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].NotObject);
        }
        if (log != null) {
            return log.get();
        }
    ...
    SchemaChecker.prototype.checkByColumn_ = function (column, value) {
        ...
        if (column.notNull === true && isNull(value)) {
            log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].NullValue, { ColumnName: column.name });
        }
        // check datatype
        var type = Object(get_data_type["a" /* getDataType */])(value);
...
var value_checker_ValueChecker = /** @class */ (function () {
    ...
    ValueChecker.prototype.checkNotNullAndDataType_ = function (column) {
        ...
        if (column.notNull && isNull(this.value[column.name])) {
            this.onValidationError_(enums["d" /* ERROR_TYPE */].NullValue, { ColumnName: column.name });
        }
        // check datatype
    ...
    ValueChecker.prototype.checkAndModifyColumnValue_ = function (column) {
        ...
        if (column.autoIncrement) {
            ...
            if (isNull(columnValue)) {
                ...
                if (Object(get_data_type["a" /* getDataType */])(columnValue) === enums["c" /* DATA_TYPE */].Number) {
    ...
    ValueChecker.prototype.onValidationError_ = function (error, details) {
        ...
        this.log = new log_helper["a" /* LogHelper */](error, details);
    };
    return ValueChecker;
}());
...
var values_checker_ValuesChecker = /** @class */ (function () {
    ...
    ValuesChecker.prototype.checkAndModifyValues = function () {
        var _this = this;
        return Object(promise["a" /* promise */])(function (resolve, reject) {
            ...
            if (query_executor["a" /* QueryExecutor */].isTransactionQuery === false) {
                Object(auto_increment_helper["a" /* getAutoIncrementValues */])(_this.table).then(function (autoIncValues) {
    ...
    ValuesChecker.prototype.startChecking = function () {
        ...
        return Object(promise["a" /* promise */])(function (resolve, reject) {
            ...
            var promiseObj = Object(auto_increment_helper["b" /* setAutoIncrementValue */])(_this.table, _this.valueCheckerObj.autoIncrementValue);
            if (query_executor["a" /* QueryExecutor */].isTransactionQuery === false) {
...
var query_helper_QueryHelper = /** @class */ (function () {
    ...
    QueryHelper.prototype.checkAndModify = function () {
        ...
        return Object(promise["a" /* promise */])(function (resolve, reject) {
            ...
            switch (_this.api) {
                case enums["a" /* API */].Select:
                case enums["a" /* API */].Remove:
                case enums["a" /* API */].Count:
                    _this.checkFetchQuery_();
                    resolveReject();
                    break;
                case enums["a" /* API */].Insert:
    ...
    QueryHelper.prototype.isInsertQryValid_ = function (callBack) {
        ...
        var log;
        if (table) {
            switch (Object(get_data_type["a" /* getDataType */])(this.query.values)) {
                case enums["c" /* DATA_TYPE */].Array:
                    break;
                case enums["c" /* DATA_TYPE */].Null:
                    log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].NoValueSupplied);
                    break;
                default:
                    log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].NotArray);
            }
        }
        else {
            log = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].TableNotExist, { tableName: this.query.into });
        }
        callBack(table);
    ...
    QueryHelper.prototype.checkUpdateQuery_ = function () {
        this.error = new schema_checker_SchemaChecker(this.getTable_(this.query.in)).
    ...
    QueryHelper.prototype.checkForNullInWhere_ = function () {
        for (var key in this.query.where) {
            if (this.query.where[key] == null) {
                this.error = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].NullValueInWhere, { column: key }).get();
                return;
            }
        }
    };
    QueryHelper.prototype.checkFetchQuery_ = function () {
        if (this.isTableExist_(this.query.from) === true) {
            ...
            this.error = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].TableNotExist, { tableName: this.query.from }).get();
        }
    };
    ...
    QueryHelper.prototype.addGreatAndLessToNotOp_ = function () {
        ...
        var containsNot = function (qry, keys) {
            return keys.findIndex(function (key) { return qry[key][enums["g" /* QUERY_OPTION */].NotEqualTo] != null; }) >= 0;
        };
        var addToSingleQry = function (qry, keys) {
            var value;
            keys.forEach(function (prop) {
                value = qry[prop];
                if (value[enums["g" /* QUERY_OPTION */].NotEqualTo] != null) {
                    qry[prop][enums["g" /* QUERY_OPTION */].GreaterThan] = value[enums["g" /* QUERY_OPTION */].NotEqualTo];
                    if (qry[enums["g" /* QUERY_OPTION */].Or] === undefined) {
                        qry[enums["g" /* QUERY_OPTION */].Or] = {};
                        qry[enums["g" /* QUERY_OPTION */].Or][prop] = {};
                    }
                    else if (qry[enums["g" /* QUERY_OPTION */].Or][prop] === undefined) {
                        qry[enums["g" /* QUERY_OPTION */].Or][prop] = {};
                    }
                    qry[enums["g" /* QUERY_OPTION */].Or][prop][enums["g" /* QUERY_OPTION */].LessThan] = value[enums["g" /* QUERY_OPTION */].NotEqualTo];
                    delete qry[prop][enums["g" /* QUERY_OPTION */].NotEqualTo];
                }
            });
            return qry;
        };
        switch (Object(get_data_type["a" /* getDataType */])(whereQuery)) {
...
// CONCATENATED MODULE: ./src/worker/keystore/business/base_logic.ts
...
var idb_helper_IdbHelper = /** @class */ (function () {
    function IdbHelper() {
    }
...
var remove_logic_Remove = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./src/worker/keystore/business/set_logic.ts
...
var set_logic_Set = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./src/worker/keystore/utils_logic.ts

var utils_logic_Utils = /** @class */ (function () {
    function Utils() {
    }
...
var tempDatas;
var init_db_logic_InitDb = /** @class */ (function () {
    function InitDb(dbName, onSuccess, onError) {
        ...
        dbRequest.onerror = function (event) {
            if (event.target.error.name === 'InvalidStateError') {
                onError({
                    ...
                    type: enums["d" /* ERROR_TYPE */].IndexedDbNotSupported
                });
            }
            else {
        ...
        dbRequest.onsuccess = function (event) {
            ...
            idb_helper_IdbHelper.dbConnection.onclose = function () {
                ...
                utils_logic_Utils.updateDbStatus(CONNECTION_STATUS.Closed, enums["d" /* ERROR_TYPE */].ConnectionClosed);
            };
...
var get_logic_Get = /** @class */ (function (_super) {
...
// CONCATENATED MODULE: ./src/worker/keystore/business/main_logic.ts
...
var main_logic_Main = /** @class */ (function () {
...
var query_executor_QueryExecutor = /** @class */ (function () {
    ...
    Clear.prototype.execute = function () {
        ...
        clearRequest.onsuccess = function (e) {
            ...
            currentTable.columns.forEach(function (column) {
                if (column.autoIncrement) {
                    instance["a" /* KeyStore */].set("JsStore_" + _this.activeDb.name + "_" + _this.query + "_" + column.name + "_Value", 0);
                }
            });
        };
...
// CONCATENATED MODULE: ./src/worker/business/init_db.ts
...
var init_db_InitDb = /** @class */ (function (_super) {
    ...
    InitDb.prototype.execute = function (tablesMetaData) {
        ...
        dbRequest.onsuccess = function (event) {
            _this.dbStatus.conStatus = enums["b" /* CONNECTION_STATUS */].Connected;
                ...
                try {
                    ...
                    item.columns.forEach(function (column) {
                        if (column.enableSearch === true) {
                            ...
                            if (column.autoIncrement) {
                                instance["a" /* KeyStore */].set("JsStore_" + _this.dbName + "_" + item.name + "_" + column.name + "_Value", 0);
                            }
                        }
                    });
                    listofTableCreated.push(item.name);
                    // setting the table version
                    instance["a" /* KeyStore */].set("JsStore_" + _this.dbName + "_" + item.name + "_Version", item.version);
                }
                catch (e) {
                    console.error(e);
                }
    ...
    InitDb.prototype.savedbNameIntoDbList_ = function () {
        var _this = this;
        return Object(promise["a" /* promise */])(function (res, rej) {
...
var select_instance = __webpack_require__(25);

// EXTERNAL MODULE: ./src/worker/business/count/instance.ts + 5 modules
var count_instance = __webpack_require__(26);

// EXTERNAL MODULE: ./src/worker/business/insert/instance.ts
var insert_instance = __webpack_require__(24);

// EXTERNAL MODULE: ./src/worker/business/remove/instance.ts + 5 modules
var remove_instance = __webpack_require__(27);

// EXTERNAL MODULE: ./src/worker/business/update/instance.ts + 5 modules
var update_instance = __webpack_require__(28);
...
var table_helper_TableHelper = /** @class */ (function () {
    ...
    TableHelper.prototype.createMetaData = function (dbName) {
        var _this = this;
        return Object(promise["a" /* promise */])(function (resolve) {
    ...
    TableHelper.prototype.setRequireDelete_ = function (dbName) {
        var _this = this;
        instance["a" /* KeyStore */].get("JsStore_" + dbName + "_" + this.name + "_Version").then(function (tableVersion) {
    ...
    TableHelper.prototype.setDbVersion_ = function (dbName) {
        var _this = this;
        idb_helper["a" /* IdbHelper */].activeDbVersion = idb_helper["a" /* IdbHelper */].activeDbVersion > this.version ? idb_helper["a" /* IdbHelper */].activeDbVersion : this.version;
        // setting db version
        instance["a" /* KeyStore */].set("JsStore_" + dbName + "_Db_Version", idb_helper["a" /* IdbHelper */].activeDbVersion);
        // setting table version
        instance["a" /* KeyStore */].set("JsStore_" + dbName + "_" + this.name + "_Version", idb_helper["a" /* IdbHelper */].activeDbVersion).then(function () {
            _this.version = idb_helper["a" /* IdbHelper */].activeDbVersion;
...
var db_helper_DbHelper = /** @class */ (function () {
    ...
    DbHelper.prototype.createMetaData = function () {
        var _this = this;
        return Object(promise_all["a" /* promiseAll */])(this.tables.map(function (table) {
...
var table_Table = /** @class */ (function () {
...
var database_DataBase = /** @class */ (function () {
...
var query_executor_QueryExecutor = /** @class */ (function () {
    function QueryExecutor(fn) {
        ...
        query_helper["a" /* QueryHelper */].autoIncrementValues = {};
    }
    QueryExecutor.prototype.checkConnectionAndExecuteLogic = function (request) {
        var _this = this;
        log_helper["a" /* LogHelper */].log('request executing:' + request.name);
        switch (request.name) {
            case enums["a" /* API */].InitDb:
            case enums["a" /* API */].IsDbExist:
            case enums["a" /* API */].GetDbVersion:
            case enums["a" /* API */].GetDbList:
            case enums["a" /* API */].GetDbSchema:
            case enums["a" /* API */].Get:
            case enums["a" /* API */].Set:
            case enums["a" /* API */].ChangeLogStatus:
            case enums["a" /* API */].Terminate:
            case enums["a" /* API */].OpenDb:
            ...
            default:
                switch (this.dbStatus_.conStatus) {
                    case enums["b" /* CONNECTION_STATUS */].Connected:
                        {
                            this.executeLogic_(request);
                        }
                        break;
                    case enums["b" /* CONNECTION_STATUS */].Closed:
                        {
    ...
    QueryExecutor.prototype.changeLogStatus_ = function (status, onSuccess, onError) {
        config["a" /* Config */].isLogEnabled = status;
        onSuccess();
    };
    QueryExecutor.prototype.returnResult_ = function (result) {
        if (config["a" /* Config */].isRuningInWorker === true) {
    ...
    QueryExecutor.prototype.executeLogic_ = function (request) {
        ...
        QueryExecutor.isTransactionQuery = request.name === enums["a" /* API */].Transaction;
        switch (request.name) {
            case enums["a" /* API */].InitDb:
                if (this.isDbDeletedByBrowser_ === true) {
                    this.initDb_(null, function () {
            ...
            case enums["a" /* API */].OpenDb:
                ...
                break;
            case enums["a" /* API */].Select:
                new select_instance["a" /* Instance */](request.query, onSuccess, onError).execute();
                break;
            case enums["a" /* API */].Insert:
                new insert_instance["a" /* Instance */](request.query, onSuccess, onError).execute();
                break;
            case enums["a" /* API */].Update:
                new update_instance["a" /* Instance */](request.query, onSuccess, onError).execute();
                break;
            case enums["a" /* API */].Remove:
                new remove_instance["a" /* Instance */](request.query, onSuccess, onError).execute();
                break;
            case enums["a" /* API */].IsDbExist:
            ...
            case enums["a" /* API */].ChangeLogStatus:
                ...
                break;
            case enums["a" /* API */].Transaction:
                new transaction_instance["a" /* Instance */](request.query, onSuccess, onError).execute();
                break;
            case enums["a" /* API */].CloseDb:
            case enums["a" /* API */].Terminate:
        ...
        if (this.activeDb_ != null && this.activeDb_.name === dbName) {
            ...
            this.getDbSchema_(dbName).then(function (db) {
                if (db != null) {
                    ...
                    onError(new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].DbNotExist, { dbName: dbName }).get());
                }
            }).catch(onError);
        }
    };
    QueryExecutor.prototype.initKeyStore_ = function (onSuccess) {
        instance["a" /* KeyStore */].init().then(onSuccess()).catch(function () {
    ...
    QueryExecutor.prototype.getDbSchema_ = function (dbName) {
        return idb_helper["a" /* IdbHelper */].getDbSchema(dbName);
    };
    QueryExecutor.prototype.terminate_ = function (onSuccess, onError) {
        var _this = this;
        instance["a" /* KeyStore */].close().then(function () {
            _this.closeDb_();
            onSuccess();
        });
    };
    Object.defineProperty(QueryExecutor.prototype, "isDbDeletedByBrowser_", {
        get: function () {
            return idb_helper["a" /* IdbHelper */].isDbDeletedByBrowser;
        },
        set: function (value) {
    ...
    QueryExecutor.prototype.getDbList_ = function () {
        return idb_helper["a" /* IdbHelper */].getDbList();
    };
    ...
    QueryExecutor.prototype.closeDb_ = function () {
        if (idb_helper["a" /* IdbHelper */].dbStatus.conStatus === enums["b" /* CONNECTION_STATUS */].Connected) {
            idb_helper["a" /* IdbHelper */].dbStatus.conStatus = enums["b" /* CONNECTION_STATUS */].ClosedByJsStore;
            idb_helper["a" /* IdbHelper */].dbConnection.close();
        }
    };
    QueryExecutor.prototype.dropDb_ = function (onSuccess, onError) {
        this.closeDb_();
        new drop_db["a" /* DropDb */](onSuccess, onError).deleteDb();
    };
        ...
        return Object(promise["a" /* promise */])(function (res, rej) {
            ...
            dbHelper.createMetaData().then(function (tablesMetaData) {
                ...
                var createDbInstance = new init_db_InitDb(function (isDbCreated) {
                    ...
                    instance["a" /* KeyStore */].set("JsStore_" + db.name + "_Schema", db);
                    res(isDbCreated);
                }, rej);
    ...
    Object.defineProperty(QueryExecutor.prototype, "activeDbVersion_", {
        get: function () {
            return idb_helper["a" /* IdbHelper */].activeDbVersion;
        },
        set: function (value) {
    ...
    QueryExecutor.prototype.getDbVersion_ = function (dbName) {
        return idb_helper["a" /* IdbHelper */].getDbVersion(dbName);
    };
    ...
    QueryExecutor.prototype.checkForIdbSupport_ = function () {
        if (this.dbStatus_.conStatus === enums["b" /* CONNECTION_STATUS */].UnableToStart) {
            var error = {
                type: this.dbStatus_.lastError,
            };
            switch (error.type) {
                case enums["d" /* ERROR_TYPE */].IndexedDbNotSupported:
    ...
    QueryExecutor.prototype.isDbExist_ = function (dbInfo, onSuccess, onError) {
        if (Object(get_data_type["a" /* getDataType */])(dbInfo) === enums["c" /* DATA_TYPE */].String) {
    ...
    QueryExecutor.prototype.get_ = function (key) {
        return instance["a" /* KeyStore */].get(key);
    };
    QueryExecutor.prototype.set_ = function (query) {
        return instance["a" /* KeyStore */].set(query.key, query.value);
    };
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BaseDb; });
...
var BaseDb = /** @class */ (function () {
    ...
    Object.defineProperty(BaseDb.prototype, "dbStatus", {
        get: function () {
            return _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].dbStatus;
        },
        set: function (value) {
    ...
    Object.defineProperty(BaseDb.prototype, "dbConnection", {
        get: function () {
            return _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].dbConnection;
        },
        set: function (value) {
    ...
    BaseDb.prototype.updateDbStatus = function (status, err) {
        _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].updateDbStatus(status, err);
    };
    BaseDb.prototype.onDbDroppedByBrowser = function (deleteMetaData) {
        _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].callDbDroppedByBrowser(deleteMetaData);
    };
    ...
    BaseDb.prototype.getDbList = function () {
        return _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].getDbList();
    };
    BaseDb.prototype.setDbList = function (value) {
        return _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].setDbList(value);
    };
    BaseDb.prototype.onDbClose = function (event) {
        this.onDbDroppedByBrowser();
        this.updateDbStatus(_enums__WEBPACK_IMPORTED_MODULE_1__[/* CONNECTION_STATUS */ "b"].Closed, _enums__WEBPACK_IMPORTED_MODULE_1__[/* ERROR_TYPE */ "d"].ConnectionClosed);
    };
    ...
    BaseDb.prototype.onDbConError = function (e) {
        _idb_helper__WEBPACK_IMPORTED_MODULE_0__[/* IdbHelper */ "a"].dbStatus.lastError = ("Error occured in connection :" + e.target.result);
    };
    return BaseDb;
}());
...
/* harmony import */ var _helpers_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(12);
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DropDb = /** @class */ (function (_super) {
    ...
    DropDb.prototype.deleteMetaData = function () {
        ...
        return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_4__[/* promise */ "a"])(function (res, rej) {
            _keystore_index__WEBPACK_IMPORTED_MODULE_0__[/* KeyStore */ "a"].remove("JsStore_" + _this.dbName + "_Db_Version");
            _this.activeDb.tables.forEach(function (table) {
                _keystore_index__WEBPACK_IMPORTED_MODULE_0__[/* KeyStore */ "a"].remove("JsStore_" + _this.dbName + "_" + table.name + "_Version");
                table.columns.forEach(function (column) {
                    if (column.autoIncrement) {
                        _keystore_index__WEBPACK_IMPORTED_MODULE_0__[/* KeyStore */ "a"].remove("JsStore_" + _this.dbName + "_" + table.name + "_" + column.name + "_Value");
                    }
                });
            });
            ...
            _this.getDbList().then(function (dbList) {
                ...
                _this.setDbList(dbList).then(function () {
                    ...
                    _keystore_index__WEBPACK_IMPORTED_MODULE_0__[/* KeyStore */ "a"].remove("JsStore_" + _this.dbName + "_Schema").
                        then(res).catch(rej);
                });
            });
        });
        ...
        setTimeout(function () {
            ...
            dropDbRequest.onblocked = function () {
                if (_this.onError_ != null) {
                    _this.onError_(new _log_helper__WEBPACK_IMPORTED_MODULE_2__[/* LogHelper */ "a"](_enums__WEBPACK_IMPORTED_MODULE_1__[/* ERROR_TYPE */ "d"].DbBlocked).get());
                }
            };
            ...
            dropDbRequest.onsuccess = function () {
                _this.deleteMetaData().then(function () {
                    _this.onSuccess_();
                    _this.dbStatus.conStatus = _enums__WEBPACK_IMPORTED_MODULE_1__[/* CONNECTION_STATUS */ "b"].Closed;
...
var Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        var _this = this;
        var queryHelper = new _query_helper__WEBPACK_IMPORTED_MODULE_3__[/* QueryHelper */ "a"](_enums__WEBPACK_IMPORTED_MODULE_4__[/* API */ "a"].Insert, this.query);
    ...
    Instance.prototype.insertData_ = function (values) {
        ...
        Object(_helpers_index__WEBPACK_IMPORTED_MODULE_1__[/* promiseAll */ "a"])(values.map(function (value) {
            return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_2__[/* promise */ "a"])(function (res, rej) {
...
var where_base = __webpack_require__(11);
...
var BaseSelect = /** @class */ (function (_super) {
    ...
    return BaseSelect;
}(where_base["a" /* WhereBase */]));


// EXTERNAL MODULE: ./src/worker/log_helper.ts
var log_helper = __webpack_require__(1);

// CONCATENATED MODULE: ./src/worker/business/select/not_where.ts
    ...
    NotWhere.prototype.executeWhereUndefinedLogic = function () {
        if (this.query.order && this.query.order.by && this.query.order.idbSorting !== false) {
            if (this.objectStore.indexNames.contains(this.query.order.by)) {
                ...
                var error = new log_helper["a" /* LogHelper */](enums["d" /* ERROR_TYPE */].ColumnNotExist, { column: this.query.order.by, isOrder: true });
                this.onErrorOccured(error, true);
                return;
            }
        }
...
var skip;
var cursor;
var in_In = /** @class */ (function (_super) {
    ...
    In.prototype.executeSkipAndLimitForIn_ = function (column, values) {
        ...
        Object(promise_all["a" /* promiseAll */])(values.map(function (val) {
...
// CONCATENATED MODULE: ./src/worker/business/select/regex.ts
...
// CONCATENATED MODULE: ./src/worker/business/select/where.ts
...
var group_by_helper_GroupByHelper = /** @class */ (function (_super) {
    ...
    GroupByHelper.prototype.executeAggregateGroupBy = function () {
        ...
        var calculateAggregate = function () {
            ...
            for (var prop in aggregateQry) {
                ...
                var aggregateValType = Object(get_data_type["a" /* getDataType */])(aggregateColumn);
                var aggregateCalculator = void 0;
                switch (prop) {
                    case enums["g" /* QUERY_OPTION */].Count:
                        aggregateCalculator = getCount;
                        break;
                    case enums["g" /* QUERY_OPTION */].Max:
                        aggregateCalculator = getMax;
                        break;
                    case enums["g" /* QUERY_OPTION */].Min:
                        aggregateCalculator = getMin;
                        break;
                    case enums["g" /* QUERY_OPTION */].Sum:
                        aggregateCalculator = getSum;
                        break;
                    case enums["g" /* QUERY_OPTION */].Avg:
        ...
        if (aggregateQry.avg) {
            if (Object(get_data_type["a" /* getDataType */])(aggregateQry.avg) === enums["c" /* DATA_TYPE */].String) {
                for (index in datas) {
                ...
                var isCountTypeString = Object(get_data_type["a" /* getDataType */])(aggregateQry.count) === enums["c" /* DATA_TYPE */].String;
                var isSumTypeString = Object(get_data_type["a" /* getDataType */])(aggregateQry.sum) === enums["c" /* DATA_TYPE */].String;
                for (index in datas) {
...
var orderby_helper_Helper = /** @class */ (function (_super) {
    ...
    Helper.prototype.getValueComparer_ = function (column, order) {
        ...
        switch (column.dataType) {
            ...
            case enums["c" /* DATA_TYPE */].Number:
                ...
                break;
            case enums["c" /* DATA_TYPE */].DateTime:
                if (order.type === 'asc') {
...
var instance_Instance = /** @class */ (function (_super) {
    ...
    function Instance(query, onSuccess, onError) {
        ...
        if (query.order) {
            if (Object(is_array["a" /* isArray */])(query.order)) {
...
// CONCATENATED MODULE: ./src/worker/business/count/base_count.ts
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
// CONCATENATED MODULE: ./src/worker/business/count/regex.ts
var regex_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
// CONCATENATED MODULE: ./src/worker/business/count/where.ts
var where_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var instance_Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        var _this = this;
        var queryHelper = new query_helper["a" /* QueryHelper */](enums["a" /* API */].Count, this.query);
        queryHelper.checkAndModify();
        if (queryHelper.error == null) {
            try {
                var getDataFromSelect = function () {
                    var selectInstance = new instance["a" /* Instance */](_this.query, function (results) {
                ...
                if (this.query.join == null) {
                    if (this.query.where != null) {
                        if (this.query.where.or || Object(is_array["a" /* isArray */])(this.query.where)) {
                            getDataFromSelect();
                        }
                        else {
                            this.initTransaction_();
    ...
    Instance.prototype.initTransaction_ = function () {
        this.createTransaction([this.query.from], this.onTransactionCompleted_, enums["e" /* IDB_MODE */].ReadOnly);
...
// CONCATENATED MODULE: ./src/worker/business/remove/base_remove.ts
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
// CONCATENATED MODULE: ./src/worker/business/remove/regex.ts
var regex_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
// CONCATENATED MODULE: ./src/worker/business/remove/where.ts
var where_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var instance_Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        var queryHelper = new query_helper["a" /* QueryHelper */](enums["a" /* API */].Remove, this.query);
        queryHelper.checkAndModify();
        if (queryHelper.error == null) {
            try {
                this.initTransaction_();
    ...
    Instance.prototype.processWhereArrayQry = function () {
        var _this = this;
        var selectObject = new instance["a" /* Instance */](this.query, function (results) {
            var _a, _b;
            var keyList = [];
    ...
    Instance.prototype.orQuerySuccess_ = function () {
        var key = Object(get_object_first_key["a" /* getObjectFirstKey */])(this._orInfo.OrQuery);
        if (key != null) {
            var where = {};
...
// CONCATENATED MODULE: ./src/worker/business/update/base_update.ts
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var updateValue = function (suppliedValue, storedValue) {
    for (var key in suppliedValue) {
        if (Object(get_data_type["a" /* getDataType */])(suppliedValue[key]) !== enums["c" /* DATA_TYPE */].Object) {
...
// CONCATENATED MODULE: ./src/worker/business/update/regex.ts
var regex_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var regex_Regex = /** @class */ (function (_super) {
    regex_extends(Regex, _super);
    function Regex() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
// CONCATENATED MODULE: ./src/worker/business/update/where.ts
var where_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var where_Where = /** @class */ (function (_super) {
    where_extends(Where, _super);
    function Where() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var instance_Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        var queryHelper = new query_helper["a" /* QueryHelper */](enums["a" /* API */].Update, this.query);
        queryHelper.checkAndModify();
        if (queryHelper.error == null) {
            try {
                this.initTransaction();
    ...
    Instance.prototype.executeComplexLogic_ = function () {
        var _this = this;
        var selectObject = new instance["a" /* Instance */]({
            from: this.query.in,
            ...
            results = null;
            var whereQry = (_a = {}, _a[key] = (_b = {}, _b[enums["g" /* QUERY_OPTION */].In] = inQuery, _b), _a);
            _this.query.ignoreCase = null;
            _this.query[enums["g" /* QUERY_OPTION */].Where] = whereQry;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getDataType; });
/* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);

var getDataType = function (value) {
    if (value == null) {
        return _enums__WEBPACK_IMPORTED_MODULE_0__[/* DATA_TYPE */ "c"].Null;
    }
    var type = typeof value;
    switch (type) {
        case 'object':
            if (Array.isArray(value)) {
                return _enums__WEBPACK_IMPORTED_MODULE_0__[/* DATA_TYPE */ "c"].Array;
            }
            else if (value.getDate && value.getTime) {
                return _enums__WEBPACK_IMPORTED_MODULE_0__[/* DATA_TYPE */ "c"].DateTime;
            }
        default:
            return type;
    }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getObjectFirstKey; });
...
/* harmony import */ var _count_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26);
...
/* harmony import */ var _update_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28);
...
var Instance = /** @class */ (function (_super) {
    ...
    Instance.prototype.execute = function () {
        ...
        if (notExistingTable != null) {
            this.onError(new _log_helper__WEBPACK_IMPORTED_MODULE_8__[/* LogHelper */ "a"](_enums__WEBPACK_IMPORTED_MODULE_6__[/* ERROR_TYPE */ "d"].TableNotExist, { tableName: notExistingTable }).get());
            return;
        }
        Object(_helpers_index__WEBPACK_IMPORTED_MODULE_9__[/* promiseAll */ "a"])(this.query.tables.map(function (table) {
            return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_10__[/* getAutoIncrementValues */ "a"])(_this.getTable(table));
        })).then(function (results) {
            results.forEach(function (result, index) {
                _query_helper__WEBPACK_IMPORTED_MODULE_7__[/* QueryHelper */ "a"].autoIncrementValues[_this.query.tables[index]] = result;
            });
    ...
    Instance.prototype.startExecution_ = function () {
        ...
        var select = function (qry) {
            return _this.pushRequest_({
                name: _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Select,
                query: qry
            });
        };
        var insert = function (qry) {
            return _this.pushRequest_({
                name: _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Insert,
                query: qry
            });
        };
        var update = function (qry) {
            return _this.pushRequest_({
                name: _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Update,
                query: qry
            });
        };
        var remove = function (qry) {
            return _this.pushRequest_({
                name: _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Remove,
                query: qry
            });
        };
        var count = function (qry) {
            return _this.pushRequest_({
                name: _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Count,
                query: qry
            });
        };
    ...
    Instance.prototype.executeRequest_ = function (request) {
        ...
        switch (request.name) {
            case _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Select:
                requestObj = new _select_index__WEBPACK_IMPORTED_MODULE_1__[/* Instance */ "a"](request.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Insert:
                requestObj = new _insert_index__WEBPACK_IMPORTED_MODULE_3__[/* Instance */ "a"](request.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Update:
                requestObj = new _update_index__WEBPACK_IMPORTED_MODULE_5__[/* Instance */ "a"](request.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Remove:
                requestObj = new _remove_index__WEBPACK_IMPORTED_MODULE_4__[/* Instance */ "a"](request.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
                break;
            case _enums__WEBPACK_IMPORTED_MODULE_6__[/* API */ "a"].Count:
                requestObj = new _count_index__WEBPACK_IMPORTED_MODULE_2__[/* Instance */ "a"](request.query, this.onRequestFinished_.bind(this), this.onError.bind(this));
                break;
        }
    ...
    Instance.prototype.pushRequest_ = function (request) {
        ...
        var promiseObj = Object(_helpers_index__WEBPACK_IMPORTED_MODULE_11__[/* promise */ "a"])(function (resolve, reject) {
            request.onSuccess = function (result) {
                resolve(result);
            };
            request.onError = function (error) {
    ...
    Instance.prototype.checkQueries_ = function (requestQueue) {
        return Object(_helpers_index__WEBPACK_IMPORTED_MODULE_9__[/* promiseAll */ "a"])(requestQueue.map(function (request) {
            var tableName = request.query.into || request.query.in;
            return new _query_helper__WEBPACK_IMPORTED_MODULE_7__[/* QueryHelper */ "a"](request.name, request.query).checkAndModify();
        }));
    };
