...
export declare class BaseDb {
    ...
    protected get dbStatus(): import("../../common/interfaces").IDbStatus;
    protected set dbStatus(value: import("../../common/interfaces").IDbStatus);
    ...
    protected get activeDb(): import("../model/database").DataBase;
